...
ElDialogProps.ɵfac = function ElDialogProps_Factory(t) { return new (t || ElDialogProps)(); };
ElDialogProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElDialogProps, inputs: { center: "center", top: "top", closeOnClickModal: ["close-on-click-modal", "closeOnClickModal"], closeOnPressEscape: ["close-on-press-escape", "closeOnPressEscape"], lockScroll: ["lock-scroll", "lockScroll"], showClose: ["show-close", "showClose"], beforeClose: ["before-close", "beforeClose"], dialogZindex: ["dialog-zindex", "dialogZindex"], modalZindex: ["modal-zindex", "modalZindex"], visible: "visible", title: "title", width: "width", customClass: ["custom-class", "customClass"] }, outputs: { visibleChange: "visibleChange" } });
