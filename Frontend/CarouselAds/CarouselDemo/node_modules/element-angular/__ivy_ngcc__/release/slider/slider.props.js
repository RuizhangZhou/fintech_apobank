...
ElSliderProps.ɵfac = function ElSliderProps_Factory(t) { return new (t || ElSliderProps)(); };
ElSliderProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElSliderProps, inputs: { elDisabled: "elDisabled", min: "min", max: "max", showTooltip: ["show-tooltip", "showTooltip"], vertical: "vertical", height: ["vertical-height", "height"], model: "model", disabled: "disabled", formatTooltip: ["format-tooltip", "formatTooltip"] }, outputs: { modelChange: "modelChange" } });
