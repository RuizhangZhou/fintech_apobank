...
ElCheckboxGroup.ɵfac = function ElCheckboxGroup_Factory(t) { return new (t || ElCheckboxGroup)(); };
ElCheckboxGroup.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ElCheckboxGroup, selectors: [["el-checkbox-group"]], inputs: { model: "model", fill: "fill", textColor: ["text-color", "textColor"], min: "min", max: "max", size: "size" }, outputs: { modelChange: "modelChange" }, features: [ɵngcc0.ɵɵProvidersFeature([{
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(function () { return ElCheckboxGroup; }),
                multi: true
            }]), ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0, decls: 2, vars: 0, consts: [["role", "group", "aria-label", "checkbox-group", 1, "el-checkbox-group"]], template: function ElCheckboxGroup_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵprojection(1);
        ɵngcc0.ɵɵelementEnd();
    } }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ElCheckboxGroup, [{
        type: Component,
        args: [{
