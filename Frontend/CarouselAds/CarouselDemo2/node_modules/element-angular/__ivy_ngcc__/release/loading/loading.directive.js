...
ElLoadingDirective.ɵfac = function ElLoadingDirective_Factory(t) { return new (t || ElLoadingDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DocumentWrapper), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.WindowWrapper)); };
ElLoadingDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElLoadingDirective, selectors: [["", "el-loading", ""]], inputs: { lock: "lock", fullScreen: ["full-screen", "fullScreen"], elLoadingTop: ["el-loading-top", "elLoadingTop"], showLoading: ["el-loading", "showLoading"], text: "text", customClass: ["custom-class", "customClass"] } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ElLoadingDirective, [{
        type: Directive,
        args: [{
                selector: '[el-loading]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }, { type: ɵngcc1.DocumentWrapper }, { type: ɵngcc1.WindowWrapper }]; }, { lock: [{
            type: Input
        }], fullScreen: [{
            type: Input,
            args: ['full-screen']
