...
ElSliderButton.ɵfac = function ElSliderButton_Factory(t) { return new (t || ElSliderButton)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.ElSlider, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DomSanitizer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
ElSliderButton.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ElSliderButton, selectors: [["el-slider-button"]], inputs: { elDisabled: "elDisabled", model: "model", vertical: "vertical", min: "min", max: "max", disabled: "disabled", formatTooltip: ["format-tooltip", "formatTooltip"] }, outputs: { modelChange: "modelChange" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 7, vars: 10, consts: [[1, "el-slider__button-wrapper", 3, "mouseenter", "mouseleave", "mousedown"], [1, "el-slider__button", "el-tooltip", 3, "mouseenter", "mouseleave"], ["wrapper", ""], ["x-placement", "top", 1, "el-tooltip__popper", "is-dark", "popper-center"], ["x-arrow", "", 1, "popper__arrow", 2, "left", "50%", "transform", "translateX(-50%)"]], template: function ElSliderButton_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵlistener("mouseenter", function ElSliderButton_Template_div_mouseenter_0_listener() { return ctx.togglePopper(true); })("mouseleave", function ElSliderButton_Template_div_mouseleave_0_listener() { return ctx.togglePopper(false); })("mousedown", function ElSliderButton_Template_div_mousedown_0_listener($event) { return ctx.buttonDownHandle($event); });
        ɵngcc0.ɵɵelementStart(1, "div", 1, 2);
        ɵngcc0.ɵɵlistener("mouseenter", function ElSliderButton_Template_div_mouseenter_1_listener() { return ctx.popperMouseHandle(true); })("mouseleave", function ElSliderButton_Template_div_mouseleave_1_listener() { return ctx.popperMouseHandle(false); });
        ɵngcc0.ɵɵelementEnd();
        ...
        ɵngcc0.ɵɵstyleMap(ctx.wrapperStyles);
        ɵngcc0.ɵɵclassProp("hover", ctx.hovering)("dragging", ctx.dragging)("isVertical", ctx.vertical);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("@fadeAnimation", !ctx.showPopper);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵtextInterpolate(ctx.formatValue());
    } }, styles: [".popper-center[_ngcontent-%COMP%] {\n      position: absolute;\n      left: 15px;\n      top: -35px;\n      display: none;\n      transform: translateX(-50%);\n    }\n    .isVertical[_ngcontent-%COMP%] { margin-left: 2px; }"], data: { animation: [fadeAnimation] } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ElSliderButton, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc1.ElSlider, decorators: [{
                type: Optional
            }] }, { type: ɵngcc2.DomSanitizer }, { type: ɵngcc0.Renderer2 }]; }, { elDisabled: [{
            type: Input
        }], model: [{
            type: Input
        }], vertical: [{
