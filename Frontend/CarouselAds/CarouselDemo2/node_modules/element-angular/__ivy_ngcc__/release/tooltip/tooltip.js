...
var _c0 = ["tip"];
var _c1 = ["popperContent"];
function ElTooltip_ng_template_4_Template(rf, ctx) { }
var _c2 = ["*"];
...
ElTooltip.ɵfac = function ElTooltip_Factory(t) { return new (t || ElTooltip)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.WindowWrapper)); };
ElTooltip.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ElTooltip, selectors: [["el-tooltip"]], contentQueries: function ElTooltip_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, _c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.tip = _t.first);
    } }, viewQuery: function ElTooltip_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c1, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.popperContent = _t.first);
    } }, inputs: { elDisabled: "elDisabled", watch: "watch", placement: "placement", effect: "effect", visibleArrow: ["visible-arrow", "visibleArrow"], disabled: "disabled", popperClass: "popperClass" }, ngContentSelectors: _c2, decls: 6, vars: 6, consts: [[2, "position", "relative", "display", "inline-block"], [2, "left", "-20000px", "top", "0", "position", "absolute"], ["popperContent", ""], ["x-arrow", "", 1, "popper__arrow", 3, "hidden"], [3, "ngTemplateOutlet"]], template: function ElTooltip_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵelementStart(1, "div", 1, 2);
        ɵngcc0.ɵɵelement(3, "div", 3);
        ɵngcc0.ɵɵtemplate(4, ElTooltip_ng_template_4_Template, 0, 0, "ng-template", 4);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵprojection(5);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵclassMap("el-tooltip__popper is-" + ctx.effect + " " + ctx.popperClass);
        ɵngcc0.ɵɵproperty("@fadeAnimation", !ctx.showPopper);
        ɵngcc0.ɵɵattribute("x-placement", ctx.xPlacement);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("hidden", !ctx.visibleArrow);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.tip);
    } }, directives: [ɵngcc2.NgTemplateOutlet], encapsulation: 2, data: { animation: [fadeAnimation] } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ElTooltip, [{
        type: Component,
        args: [{
                selector: 'el-tooltip',
    ...
    }], function () { return [{ type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ElementRef }, { type: ɵngcc1.WindowWrapper }]; }, { elDisabled: [{
            type: Input
        }], watch: [{
            type: Input
        }], placement: [{
