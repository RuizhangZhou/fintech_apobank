...
ElInputPoprs.ɵfac = function ElInputPoprs_Factory(t) { return new (t || ElInputPoprs)(); };
ElInputPoprs.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElInputPoprs, inputs: { type: "type", value: "value", placeholder: "placeholder", rows: "rows", autoComplete: ["auto-complete", "autoComplete"], nativeType: ["native-type", "nativeType"], readonly: "readonly", autofocus: "autofocus", model: "model", elDisabled: "elDisabled", disabled: "disabled", maxlength: "maxlength", minlength: "minlength", size: "size", resize: "resize", icon: "icon", iconClass: "iconClass", autosize: "autosize", name: "name", parentClass: ["class", "parentClass"] }, outputs: { modelChange: "modelChange", iconClick: "icon-click", focus: "focus", blur: "blur", iconMouseEnter: "icon-mouseenter", iconMouseLeave: "icon-mouseleave", iconMousedown: "icon-mousedown", iconMouseup: "icon-mouseup" } });
