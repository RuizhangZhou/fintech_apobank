...
ElUploadProps.ɵfac = function ElUploadProps_Factory(t) { return new (t || ElUploadProps)(); };
ElUploadProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElUploadProps, inputs: { elDisabled: "elDisabled", data: "data", name: "name", drag: "drag", multiple: "multiple", headers: "headers", withCredentials: ["with-credentials", "withCredentials"], showFileList: ["show-file-list", "showFileList"], listType: ["list-type", "listType"], fileList: ["file-list", "fileList"], uploadFilter: ["upload-filter", "uploadFilter"], disabled: "disabled", action: "action", accept: "accept" }, outputs: { preview: "preview", remove: "remove", progress: "progress", success: "success", error: "error" } });
