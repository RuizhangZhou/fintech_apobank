...
ElTreeProps.ɵfac = function ElTreeProps_Factory(t) { return new (t || ElTreeProps)(); };
ElTreeProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElTreeProps, inputs: { emptyText: ["empty-text", "emptyText"], showCheckbox: ["show-checkbox", "showCheckbox"], defaultExpandAll: ["default-expand-all", "defaultExpandAll"], defaultExpandedKeys: ["default-expanded-keys", "defaultExpandedKeys"], defaultCheckedKeys: ["default-checked-keys", "defaultCheckedKeys"], expandOnClickNode: ["expand-on-click-node", "expandOnClickNode"], indent: "indent", accordion: "accordion", elDisabled: "elDisabled", disabled: "disabled" }, outputs: { modelChange: "modelChange" } });
