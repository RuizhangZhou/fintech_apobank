...
ElTableProps.ɵfac = function ElTableProps_Factory(t) { return new (t || ElTableProps)(); };
ElTableProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElTableProps, inputs: { height: "height", placeholder: "placeholder", stripe: "stripe", border: "border", scrollX: ["scroll-x", "scrollX"], showHeader: ["show-header", "showHeader"], center: "center", model: "model", rowClassName: ["row-class-name", "rowClassName"] }, outputs: { modelChange: "modelChange", select: "select", selectAll: "select-all", selectionChange: "selection-change", cellMouseEnter: "cell-mouse-enter", cellMouseLeave: "cell-mouse-leave", cellClick: "cell-click", cellDblclick: "cell-dblclick" } });
