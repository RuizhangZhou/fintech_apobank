...
ElRateProps.ɵfac = function ElRateProps_Factory(t) { return new (t || ElRateProps)(); };
ElRateProps.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ElRateProps, inputs: { elDisabled: "elDisabled", max: "max", colors: "colors", voidColor: ["void-color", "voidColor"], iconClasses: ["icon-classes", "iconClasses"], voidIconClass: ["void-icon-class", "voidIconClass"], disabledVoidColor: ["disabled-void-color", "disabledVoidColor"], disabledVoidIconClass: ["disabled-void-icon-class", "disabledVoidIconClass"], lowThreshold: ["low-threshold", "lowThreshold"], highThreshold: ["high-threshold", "highThreshold"], showText: ["show-text", "showText"], textColor: ["text-color", "textColor"], texts: "texts", model: "model", disabled: "disabled" }, outputs: { modelChange: "modelChange" } });
